...
public class ProcedureDAO {
    ...
    public static void viewProcedures() {
        ...
        String query = "SELECT `proc_id`, `name`, `Duration (minutes)`, `cause`, `surgical?` FROM `procedures`";
    ...
    public static void addProcedure(Scanner scanner) {
        ...
        String query = "INSERT INTO `procedures` (`name`, `Duration (minutes)`, `cause`, `surgical?`) VALUES (?, ?, ?, ?)";
    ...
    public static void updateProcedure(Scanner scanner) {
        ...
        String query = "UPDATE `procedures` SET `name`=?, `Duration (minutes)`=?, `cause`=?, `surgical?`=? WHERE `proc_id`=?";
    ...
    public static void deleteProcedure(Scanner scanner) {
        ...
        String query = "DELETE FROM `procedures` WHERE `proc_id` = ?";
